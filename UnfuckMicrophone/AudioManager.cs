...
// But I added some code to manage mic.
using System;
...
namespace VideoPlayerController
{
    ...
    public static class AudioManager
    {
        ...
        public static float GetComMicVolume()
        {
            IAudioEndpointVolume masterVol = null;
            try
            {
                masterVol = GetMasterMicObject();
                if (masterVol == null)
                    return -1;
        ...
        public static void SetComMivVolume(float newLevel)
        {
            IAudioEndpointVolume masterVol = null;
            try
            {
        ...
        private static IAudioEndpointVolume GetMasterMicObject()
        {
            ...
            try
            {
                ...
                deviceEnumerator.GetDefaultAudioEndpoint(EDataFlow.eCapture, ERole.eCommunications, out speakers);
